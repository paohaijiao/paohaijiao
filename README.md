...
| [**jquick-pdf**](https://github.com/paohaijiao/jquick-pdf) | 业界唯一不依赖浏览器/WebKit的Java PDF生成工具：原生渲染HTML/CSS，内置30+种ECharts图表(支持动态扩展)。 | ❌ | ![Stars](https://img.shields.io/github/stars/paohaijiao/jquick-pdf?style=flat-square&label=stars)  |
